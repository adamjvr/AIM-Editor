...
namespace aim
{
class OutputPanel final : public EditorSection
{
public:
    OutputPanel (const ParameterRegistry& registry, ProgramState& state);
...
private:
    ...
    std::vector<std::unique_ptr<ParameterControl>> driveControls;
    std::vector<std::unique_ptr<ParameterControl>> levelControls;
