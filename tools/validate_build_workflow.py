...
def main() -> int:
    ...
    require(editor_page, '"Micron profile / X-Y-Z + FX2 / shared 378-byte Program"', "Micron device-aware metadata banner")
    require(editor_page, '"ION profile / fixed banks + Edit buffers / shared 378-byte Program"', "Ion device-aware metadata banner")
